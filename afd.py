...
class AFD:
    ...
    estados: List[str]
    alfabeto: List[str]
    transiciones: Dict[Tuple[str, str], str]   # (estado, simbolo_clase)
    estado_inicial: str
    estados_finales: List[str]
...
AFND_PRODUCTO.estados = ["q0", "q1", "q2", "q3", "q4", "q5", "q5a", "q6", "q7", "q8", "q9", "q9a", "q10", "q11", "qf"]
...
AFD_PRODUCTO.estados = ["q0", "q1", "q2", "q3", "q4", "q5", "q5b", "q5c","q6", "q7", "q7b", "q7c", "qf"]
